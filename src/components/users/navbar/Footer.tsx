...
import { FaFacebookF, FaInstagram, FaMapMarkerAlt, FaUniversity, FaTiktok } from "react-icons/fa";
...
function Footer() {
  ...
  // Use default social links if aboutData is not available
  const socialLinks = {
    facebook: aboutData?.facebookUrl || "https://facebook.com",
    instagram: aboutData?.instagramUrl || "https://instagram.com",
    tiktok: aboutData?.tiktokUrl || null
  };
    ...
    <footer className="bg-neutral-900 text-white pt-12 pb-6 px-6 md:px-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="space-y-4">
          ...
          <nav className="grid grid-cols-2 gap-3 text-gray-300">
            <Link
              href="/"
            ...
            <Link href="/UMKM" className="hover:text-white transition">
              UMKM
            </Link>
            <Link href="/Blog" className="hover:text-white transition">
              Artikel
            </Link>
            <Link href="/Vlog" className="hover:text-white transition">
              Vlog
            </Link>
          ...
          <div className="flex gap-3">
            ...
            {socialLinks.tiktok && (
              <Link
                ...
                className="bg-black text-white rounded-full p-3 hover:scale-110 hover:bg-gray-800 transition-all duration-300 shadow-lg"
                title="TikTok"
                target="_blank"
                rel="noopener noreferrer"
              >
