        ...
        <>
            ...
            <div className="py-16 px-4 text-center">
                ...
                <p className="max-w-3xl mx-auto text-gray-600 leading-relaxed mb-16">
                    ...
                    Atque id laudantium quisquam nobis voluptatum excepturi
                    laborum itaque quia. Dolores beatae possimus optio nesciunt
                    quis iste nemo perspiciatis, mollitia repudiandae
                    reiciendis.
                </p>
                <PilihKami />
            </div>
